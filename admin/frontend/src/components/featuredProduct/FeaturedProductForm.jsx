...
const FeaturedProductForm = ({ onSubmit, loading, initialData, isEdit, onCancel }) => {
  ...
  const handleChange = (e) => {
    ...
    if (name === 'images') {
      ...
      setForm({ ...form, highlights: { ...form.highlights, heading: value } });
      ...
      setForm({ ...form, highlights: { ...form.highlights, items: newItems } });
    } else {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white p-6 rounded shadow max-w-4xl mx-auto max-h-[80vh] overflow-y-auto">
      ...
      <div className="border-4 border-purple-500 p-6 rounded mb-6 bg-purple-50">
        ...
        <div className="mb-4">
          <label className="block text-sm font-bold text-purple-700 mb-2">Section Heading</label>
          <input
            type="text"
