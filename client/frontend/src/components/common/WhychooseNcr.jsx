      ...
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mt-12">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
            <FaShieldAlt className="mx-auto text-3xl text-[#2D5D4F] mb-4" />
            <h3 className="font-semibold text-[#2D5D4F] mb-2">
              Verified Properties
            </h3>
          ...
          {/* Card 2 */}
          <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
            <FaClock className="mx-auto text-3xl text-[#2D5D4F] mb-4" />
            <h3 className="font-semibold text-[#2D5D4F] mb-2">24/7 Support</h3>
            <p className="text-sm text-gray-600">
          ...
          {/* Card 3 */}
          <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
            <FaTags className="mx-auto text-3xl text-[#2D5D4F] mb-4" />
            <h3 className="font-semibold text-[#2D5D4F] mb-2">Best Price Guarantee</h3>
            <p className="text-sm text-gray-600">
          ...
          {/* Card 4 */}
          <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
            <FaHeart className="mx-auto text-3xl text-[#2D5D4F] mb-4" />
            <h3 className="font-semibold text-[#2D5D4F] mb-2">Memorable Experiences</h3>
            <p className="text-sm text-gray-600">
